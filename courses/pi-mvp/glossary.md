...
[See more](https://lilianweng.github.io/posts/2023-06-23-agent/) — Lilian Weng's classic survey of AI agent architectures
...
[EventEmitter pattern](https://nodejs.org/api/events.html) — Node.js's built-in implementation
...
[OpenAI Messages API](https://platform.openai.com/docs/guides/text-generation/chat-completions-api)
